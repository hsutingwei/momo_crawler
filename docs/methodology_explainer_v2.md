...
- QA 機制：model_run_v1.json 的 qa_check 紀錄 train/test 的正負樣本數，一旦不足會標記 alid_for_evaluation=false。
...
## 9. Changelog (v1 → v2)
1. 新增 label_mode，支援 fixed_window 與 lign_max_gap_days，打造高精度 alert 流程。
